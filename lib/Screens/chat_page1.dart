...
class _ChatPage1State extends State<ChatPage1> {
  ...
  Future<void> _loadMessages() async {
    ...
    final savedMessages = await databaseService.getMessages(
      ...
      widget.recipientUser, // Receiver's username
    );
    setState(() {
      ...
      MessageSender.sendMessage(messageContent, widget.deviceIp, 12345).then((result) async {
        if (result['success']) {
          final newMessage = Message(
            ...
            receiverUsername: widget.recipientUser,
  ...
  void _setupMessageListener() {
    platform.setMethodCallHandler((call) async {
      if (call.method == 'onMessageReceived') {
        ...
        final newMessage = Message(
          senderUsername: widget.recipientUser,
          ...
          child: Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(widget.recipientUser, style: TextStyle(color: Colors.black)),
                  Text(
